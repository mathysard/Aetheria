...
#[ORM\Entity(repositoryClass: LocationUserFieldsRepository::class)]
class LocationUserFields
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    private ?Locations $bookLocation = null;
    ...
    public function getBookLocation(): ?Locations
    {
        return $this->bookLocation;
    }

    public function setBookLocation(?Locations $bookLocation): static
    {
