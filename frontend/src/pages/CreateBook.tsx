...
function CreateBook() {
    const [activeScreen, setActiveScreen] = useState<"book"|"characters"|"relations"|"locations"|"chapters">("characters");
    const [characters, setCharacters] = useState<CharacterInterface[]>([]);
    const charactersDivRef = useRef(null);
    const characterFormRef = useRef(null);

    // useEffect(() => {
    //     console.log(characters[0] ? characters[0].userFields : null)
    // }, [characters]);
